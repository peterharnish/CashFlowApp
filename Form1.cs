    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            try
            {
                ...
                DateTime lastMonth = first.AddMonths(-1);
                this.dtpStartDate.Value = lastMonth;
                this.dtpEndDate.Value = first.AddSeconds(-1);
                GetHistory();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if ((expense.ID == 0) && (expense.Amount > 0) && !string.IsNullOrEmpty(expense.Category) && !string.IsNullOrEmpty(expense.ExpenseType))
                    {
